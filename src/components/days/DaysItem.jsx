...
const DaysItem = ({ city, className, onLike }) => {
  return (
    <li
      className={cn(
    ...
    >
      <div className="space-y-6.25 site-md:space-y-2.75 site-xl:space-y-3.75 px-0 site-md:px-2.25 site-xl:px-2.5 font-medium mb-2.75 site-md:mb-2 site-xl:mb-2.5">
        ...
        <p className="text-center text-[20px] site-xl:text-[24px] leading-none">{city.time}</p>
      </div>
      <div className="px-6.75 site-md:px-2.25 site-xl:px-3 flex justify-center md:justify-between flex-wrap items-center gap-2 md:gap-0 text-[10px] font-medium mb-3 site-xl:mb-3.75">
        <ButtonBrand className="py-1.5 px-2.75 site-xl:py-2 site-xl:px-4.5" onClick={() => {}}>
          Hourly forecast
        </ButtonBrand>
        <ButtonBrand className="py-1.5 px-2.75 site-xl:py-2 site-xl:px-4.5" onClick={() => {}}>
          Weekly forecast
      ...
      <div className="flex flex-col gap-6.25 site-xl:gap-3.75 items-center mb-11 site-md:mb-8.5 site-xl:mb-9.5">
        ...
        />
        <h2 className="text-[24px] site-xl:text-[32px] font-medium">{city.temperature.celsius}</h2>
      </div>
      <div className="flex justify-between items-center flex-wrap px-4.25 site-md:px-0">
        ...
        <ButtonBrand className="py-2 px-5 site-md:py-1.5 site-md:px-4.75 site-xl:py-2 site-xl:px-6.25">
          See more
        </ButtonBrand>
        <button className="size-6 site-xl:size-7.5">
